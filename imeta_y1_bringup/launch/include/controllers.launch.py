...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="imeta_y1_bringup",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_package",
            default_value="imeta_y1_description",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="imeta_y1.urdf.xacro",
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare(description_package), "rviz", "imeta_y1.rviz"]
    )
    ...
    control_node = Node(
        ...
        remappings=[
            ...
            ("/imeta_y1_trajectory_controller/joint_trajectory", "/joint_trajectory"),
        ]
    )
    ...
    robot_controller_names += ["imeta_y1_trajectory_controller"]
    ...
    inactive_robot_controller_names = ["imeta_y1_forward_position_controller"]
